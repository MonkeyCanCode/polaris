...
- Provide default region when storage configuration is missing region and credential vending enabled (controlled by `EMIT_DEFAULT_S3_CLIENT_REGION` feature flag).
